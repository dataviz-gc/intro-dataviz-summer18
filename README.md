...
| Date              | Seminar                                   | Tableau Tutorial            |
| -------------     | :-------------:                           | :-------------:             |        
| Monday, June 4    | Blog Post 1 Pin Up                        | Common Data Structure Problems |
| Tuesday, June 5   | *Explore Projects for Class:* [Dear Data 1](http://www.dear-data.com/theproject) & [Dear Data 2](http://www.dear-data-two.com/) | Data Joins |
| Wednesday, June 6 | *Read for Class:* "Raw Data" Is An Oxymoron by Lisa Gitelman | Creating New Variables | 
| Thursday, June 7 | *Bring 3 Examples to Class:* Data Visualizations in the Media | Parameters, Sets, and Hierarchies|

#### Assignment Deadlines

| Date              | Time                    | Deadline                            | Platform   |
| :-------------:   |:-------------:          | :-------------:                     |:-------------:|
| Friday, June 8    | 6:00 PM                 | Submit Proposal for Blog Post 2     | Email to Erin & Michelle |
...
| Date              | Seminar                                                   | Tableau Tutorial            |
| -------------     | :-------------:                                           | :-------------:             |        
| Monday, June 11   | Blog Post 2 Pin Up                                        | Treemaps                    |
| Tuesday, June 12  | *Read for Class:* Graphs, Maps, Trees by Franco Moretti   | Dispersion Plots            |
| Wednesday, June 13|                                                           | Bump Chart, Donut Chart     |
| Thursday, June 14 |                                                           | Bullet Graphs, Gantt Chart  |

#### Assignment Deadlines

| Date              | Time                    | Deadline                             | Platform   |
| :-------------:    |:-------------:         | :-------------:                      |:-------------:|
| Friday, June 15    | 6:00 PM                | Submit Proposal for Final Portfolio  | Email to Erin & Michelle |
...
| Date              | Seminar                                                   | Tableau Tutorial            |
| -------------     | :-------------:                                           | :-------------:             |        
| Monday, June 18   |                                                           | Presentations in Tableau with Storypoints|
| Tuesday, June 19  |                                                           | Dashboard Makeovers         |
| Wednesday, June 20| Presentations of Final Portfolios                         | n/a                         |
| Thursday, June 21 | Presentations of Final Portfolios                         | n/a                         |
